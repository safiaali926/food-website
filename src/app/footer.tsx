...
function Footer() {
    return (<>
   <footer className="bg-gray-300 grid grid-cols-4">
    <div>
        <Image src="/logo.png" alt="image" width={150} height={150} className="mx-7 mt-7"></Image>
       <Image src="/store.png" alt="image" width={150} height={150} className="m-7"></Image>
      <p className="m-7">Company# 434390-656,registered with House of companies.</p>
    </div>

    <div>
        <p className="mt-7 justify-center items-center font-bold">Get Exclusive Deals in your Inbox</p>
      ...
      <form action="#" className="mt-6">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  ...
                  <div>
                      <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-amber-400 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-amber-400 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Subscribe</button>
                  </div>
              </div>
            ...
            <Image src="/icons.png" alt="image" width={250} height={150} className=""></Image>
          
    </div>


<div className="ml-9 ">
    <h1 className="mt-8 font-bold">Quick Links</h1>
    <ul className="items-center justify-center align-text-center">
...
<div className="">
    <h1 className="mt-8 font-bold">Important Links</h1>
    <ul className="">
   ...
   <div className="bg-gray-900 text-white text-sm p-4">
    <ul className="flex gap-x-9 justify-center">
